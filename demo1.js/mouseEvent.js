...
import {steve,balls,scene,cameraOnPlayer,cameraForMouse,renderer,start,textureHUD} from './main.js'
...
function textureAnimate() {
        if (textureHUD!== undefined){
            //var texture = frame.material.map;
            switch(countSwing){
				case 0:
                ...
                case 1:
					...
					break;
                case 2:
                    textureHUD.offset.y = 1/3;
					break;
                case 3:
                    textureHUD.offset.y = 0;
					break;
            }
        }
    }
...
export {theta,beforeHit,ballMove,preInHole,useOrb,countSwingReset}
export{leftMouseDown,leftMouseUp,middleMouseDown,rightMouseDown,rightMouseUp,mouseMove,mouseWheel,mouseEvent}