...
function BuildFlag(){
  var cylinder = new THREE.Mesh(new THREE.CylinderGeometry(0.2,0.2,30,64),new THREE.MeshPhongMaterial({color:"grey"}));
 var  plane= new THREE.Mesh(new THREE.PlaneGeometry( 3, 2 ),new THREE.MeshPhongMaterial({color:'red', side: THREE.DoubleSide}));
